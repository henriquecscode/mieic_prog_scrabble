...
public:
    ...
    void checkWords(Info letter, int player);
    void makePlay(int player);
    void getPlay(int player);
    void captureLetter(Info letter, int player);
...
private:
    ...
    vector<int> points[4];
    string boardName;
    vector<vector<char>> vectorBoard;
    string boardName, plays;
    int players;
